...
GET_VALIDATE_SARON_DC_CCRY_Rates001_Real data test
    ...
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Rates\\SARON_DC_CCRY\\Response_Validation_floorComp_ccrRounding.json    encoding=utf-8-sig
