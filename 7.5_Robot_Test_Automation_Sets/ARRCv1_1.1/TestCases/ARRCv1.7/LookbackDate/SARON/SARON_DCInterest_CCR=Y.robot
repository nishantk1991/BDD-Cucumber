...
POST_VALIDATE SARON_DC_CCR=Y_NoPay_TC001- - Non Payment scenarios - Real time
    ...
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC001_NoPay.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_NoPay_TC002- - Non Payment scenarios - Real time
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC002_NoPay.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_NoPay_TC003- - Non Payment scenarios - Real time
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC003_NoPay.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_NoPay_TC004- - Non Payment scenarios - Real time
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC004_NoPay.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_NoPay_TC005- - Non Payment scenarios - Real time
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC005_NoPay.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_IntPay_TC001- Payment scenarios - Realtime
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC001.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_IntPay_TC002- Payment scenarios - Realtime
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC002.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_IntPay_TC003- Payment scenarios - Realtime
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC003.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_IntPay_TC004- Payment scenarios - Realtime
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC004.json    encoding=utf-8-sig
...
POST_VALIDATE SARON_DC_CCR=Y_IntPay_TC005- Payment scenarios - Realtime
    ...
    THEN VERIFY RESPONSE STATUS   ${RESPONSE.status_code}    200
    ${data}    Get File    ${API_EXPECTED_RESPONSE_PATH}\\ARRCv1.7\\Response_SARON_Interest\\SARON_DCI_CCRY\\Response_DCISARONTC005.json    encoding=utf-8-sig
